...
async def start(client: pr0fess0r_99, message: Message):
    ...
    button=[[
      ...
      InlineKeyboardButton("𝐉𝐎𝐈𝐍", url=f"https://t.me/+x0otbQDkyT9jMzM1")
      ]]
    await message.reply_text(text="**𝙷𝙴𝙻𝙻𝙾...⚡\n\n𝙸𝙰𝙼 𝙰 𝚂𝙸𝙼𝙿𝙻𝙴 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼 𝙰𝚄𝚃𝙾 𝚁𝙴𝚀𝚄𝙴𝚂𝚃 𝙰𝙲𝙲𝙴𝙿𝚃 𝙱𝙾𝚃.\n𝙵𝙾𝚁 𝙼𝚊𝚍𝚎 𝙱𝚢 : 𝙼𝚅 𝙴𝙵𝚇⚡\n𝙵𝙾𝚁 𝙹𝚘𝚒𝚗 𝙾𝚞𝚛 𝙲𝚑𝚊𝚗𝚗𝚎𝚕 𝙵𝚘𝚛 𝙼𝚘𝚛𝚎...**", reply_markup=InlineKeyboardMarkup(button), disable_web_page_preview=True)
